...
-- create "users" table
CREATE TABLE "users" ("id" text NOT NULL, "account_id" text NOT NULL, "name" text NOT NULL, "description" text NULL, "encrypted_seed" text NOT NULL, "public_key" text NOT NULL, "jwt" text NOT NULL, "scoped_signing_key_id" text NULL, "jwt_ttl_seconds" bigint NULL, "jwt_issued_at" timestamp NULL, "jwt_expires_at" timestamp NULL, "revoked_at" timestamp NULL, "revocation_reason" text NOT NULL DEFAULT '', "last_expiring_warn_iat" timestamp NULL, "last_expired_alert_iat" timestamp NULL, "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ("id"), CONSTRAINT "fk_users_account" FOREIGN KEY ("account_id") REFERENCES "accounts" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "fk_users_scoped_signing_key" FOREIGN KEY ("scoped_signing_key_id") REFERENCES "scoped_signing_keys" ("id") ON UPDATE NO ACTION ON DELETE SET NULL);
...
CREATE TABLE "user_jwt_revocations" ("id" text NOT NULL, "account_id" text NOT NULL, "user_id" text NULL, "user_public_key" text NOT NULL, "revoked_at" timestamp NOT NULL, "jwt_exp" timestamp NOT NULL, "reason" text NOT NULL DEFAULT '', "pruned_at" timestamp NULL, "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ("id"), CONSTRAINT "fk_user_jwt_revocations_account" FOREIGN KEY ("account_id") REFERENCES "accounts" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "fk_user_jwt_revocations_user" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE SET NULL);
