...
func NewClusterHandler(service *services.ClusterService) nisv1connect.ClusterServiceHandler {
...
func (h *ClusterHandler) ListClusters(
	...
	// If operator_id is empty, list all clusters across all operators
