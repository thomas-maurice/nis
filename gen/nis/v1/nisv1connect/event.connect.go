...
const (
	...
	EventServiceName = "nis.v1.EventService"
)
...
const (
	...
	EventServiceListEventsProcedure = "/nis.v1.EventService/ListEvents"
	// EventServiceGetEventProcedure is the fully-qualified name of the EventService's GetEvent RPC.
	EventServiceGetEventProcedure = "/nis.v1.EventService/GetEvent"
)

// EventServiceClient is a client for the nis.v1.EventService service.
...
// NewEventServiceClient constructs a client for the nis.v1.EventService service. By default, it
...
func NewEventServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EventServiceClient {
	...
	eventServiceMethods := v1.File_nis_v1_event_proto.Services().ByName("EventService").Methods()
...
// ListEvents calls nis.v1.EventService.ListEvents.
...
// GetEvent calls nis.v1.EventService.GetEvent.
...
// EventServiceHandler is an implementation of the nis.v1.EventService service.
...
func NewEventServiceHandler(svc EventServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/nis.v1.EventService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEventServiceHandler) ListEvents(context.Context, *connect.Request[v1.ListEventsRequest]) (*connect.Response[v1.ListEventsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nis.v1.EventService.ListEvents is not implemented"))
}
...
func (UnimplementedEventServiceHandler) GetEvent(context.Context, *connect.Request[v1.GetEventRequest]) (*connect.Response[v1.GetEventResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nis.v1.EventService.GetEvent is not implemented"))
}
