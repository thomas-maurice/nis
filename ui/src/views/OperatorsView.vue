<template>
  <div class="container-fluid py-4">
    ...
    <EntityList
      ...
      :loading="loading"
      :error="error"
      :can-create="authStore.isAdmin || authStore.isOrgAdmin"
      :can-edit="authStore.isAdmin || authStore.isOrgAdmin"
      :can-delete="authStore.isAdmin || authStore.isOrgAdmin"
      @create="showCreateModal"
      @edit="showEditModal"
      @delete="handleDelete"
      @select="handleSelect"
    >
      <template v-if="authStore.isAdmin || authStore.isOrgAdmin" #header-actions>
